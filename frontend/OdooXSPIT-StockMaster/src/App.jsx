...
const gradientBg =
  "bg-gradient-to-b from-slate-50 via-slate-100 to-white dark:from-slate-950 dark:via-slate-900 dark:to-slate-950";
    ...
    <div className={`min-h-screen ${isAppRoute ? gradientBg : ""}`}>
      ...
      <div className="relative z-10">
        <Routes>
          ...
          <Route
            path="/deliveries"
            element={<Delivery theme={theme} onToggleTheme={toggleTheme} />}
          />
          <Route
            path="/stock"
            element={<Stock theme={theme} onToggleTheme={toggleTheme} />}
          />
          <Route
            path="/warehouse"
          ...
          <Route
            path="/products"
            element={<Product theme={theme} onToggleTheme={toggleTheme} />}
          />
          <Route
            path="/partners"
            element={<Partner theme={theme} onToggleTheme={toggleTheme} />}
          />
          <Route
            path="/receipts"
            element={<Receipts theme={theme} onToggleTheme={toggleTheme} />}
          />
          <Route
            path="/receipts/:id"
            element={
              <ReceiptsDetail theme={theme} onToggleTheme={toggleTheme} />
            }
          />
          <Route
            path="/profile"
            element={<Profile theme={theme} onToggleTheme={toggleTheme} />}
          />
          <Route
            path="/moves"
            element={<MoveHistory theme={theme} onToggleTheme={toggleTheme} />}
          />
        </Routes>
      </div>
    </div>
